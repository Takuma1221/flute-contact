...
const reservationSchema = z.object({
  ...
  seatType: z.string().min(1, "席種を選択してください"),
  ticketCount: z.string().min(1, "チケット枚数を選択してください"),
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label
                  ...
                  className="block text-sm font-medium text-gray-700 mb-2"
                >
                  席種 <span className="text-red-500">*</span>
                </label>
                <select
                  id="seatType"
                  {...register("seatType")}
                ...
                >
                  <option value="">選択してください</option>
                  <option value="front">前席（1-3列目）¥3,500</option>
                  <option value="middle">中席（4-6列目）¥3,000</option>
                  <option value="back">後席（7列目以降）¥2,500</option>
                </select>
                {errors.seatType && (
                  <p className="mt-1 text-sm text-red-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div>
                ...
                >
                  ...
                  <option value="4+">4枚以上（備考欄に記載）</option>
                </select>
                {errors.ticketCount && (
                  <p className="mt-1 text-sm text-red-600">
          ...
          <div className="bg-slate-50 p-6 rounded-lg">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                {...register("requests")}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500"
                placeholder="特別な配慮が必要な事項やリクエスト曲などがございましたらご記入ください"
              />
            </div>
